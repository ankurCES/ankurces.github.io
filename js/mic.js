window.onload = function () {
    ...
    var h = document.getElementById('mainDb');
    var hSub = document.getElementById('subDb');
    var AudioContext;
    var audioContent;
    var start = false;
    ...
    var soundAllowed = function (stream) {
        ...
        var showVolume = function () {
            ...
            if (start) {
                ...
                h.innerHTML = "<strong>"+Math.floor(db) + " dB </strong>";
    ...
    document.getElementById('micButton').onclick = function () {
        if (start) {
            start = false;
            this.innerHTML = "<span class='fa fa-play'></span> Start Listening";
            ...
            start = true;
            this.innerHTML = "<span class='fa fa-stop'></span> Stop Listening";
