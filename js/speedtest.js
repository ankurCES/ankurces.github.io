                    ...
                    var showMoreDetails = function() {
                        ...
                        that = {
                            ...
                            onComplete: function(result) {
                                console.log('RESULT')
                                // console.log(result);
                                if(result.testType == 'download') {
                                    var download = convertSpeed(result);
                                    var down = document.getElementById('download-test');
                                    console.log(download.speed);
                                    console.log(download.units);
                                    var message = "Speed: "+download.speed+" "+ download.units;
                                    if(parseInt(download.speed) < 40){
                                        message = message + "</p><br><p>Your Internet Badwidth is Low. Consider upgrading your internet plan."
                                    }
                                    down.innerHTML = message;
                                }

                                if(result.testType == 'upload') {
                                    var upload = convertSpeed(result);
                                    console.log(upload.speed);
                                    console.log(upload.units);
                                }

                                if(result.testType == 'latency') {
                                    var latency = convertLatency(result);
                                    var lat = document.getElementById('latency-test');
                                    console.log(latency.speed);
                                    console.log(latency.units);
                                    lat.innerHTML = "Latency: "+latency.speed+" "+ latency.units;
                                }
